...
// @author       loujine
// @version      2021.9.19
// @downloadURL  https://raw.githubusercontent.com/Lioncat6/loujine-musicbrainz-scripts/master/mb-display_work_relations_for_artist_recordings.user.js
// @updateURL    https://raw.githubusercontent.com/Lioncat6/loujine-musicbrainz-scripts/master/mb-display_work_relations_for_artist_recordings.user.js
...
function showMissingWorks() {
    ...
    $recordings.each(function (idx, recording) {
        setTimeout(function () {
            const mbid = recording.href.split('/')[4];
            const url = helper.wsUrl('recording', ['work-rels'], mbid);
